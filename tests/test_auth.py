...
@patch("bifrost.auth.getpass.getpass", return_value="mypassword")
@patch("builtins.input", side_effect=["api-key", "api-secret", "username"])
@patch("bifrost.auth.pylast.LastFMNetwork")
...
@patch("bifrost.auth.getpass.getpass", return_value="")
@patch("builtins.input", side_effect=["api-key", "api-secret", "username"])
...
@patch("bifrost.auth.getpass.getpass", return_value="pass")
